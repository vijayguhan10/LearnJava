error id: file:///C:/Projects/LearnJava/Algorithims.java
file:///C:/Projects/LearnJava/Algorithims.java
...
```java
offset: 8
uri: file:///C:/Projects/LearnJava/Algorithims.java
text:
```scala
public n@@ums.stream()
    .sorted()
...
QDox parse error in file:///C:/Projects/LearnJava/Algorithims.java